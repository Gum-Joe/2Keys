 ...
 */
/**
 * Contains defintions of commands types/
 * ### What is a command?
 ...
 * that all other command should extend.
 * It defines the information needed for a command.
 * 
 * See the package documentation for this file for information on command rules, etc
 * 
