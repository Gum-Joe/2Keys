...
import { WINDOWS_DAEMON_PREFIX, DEFAULT_LOCAL_2KEYS, WINDOWS_DAEMON_FILE, WINDOWS_DAEMON_PID_FILE } from "../util/constants";
import Logger from "../util/logger";
import { writeFileSync, readFile, symlinkSync } from "fs";
...
export function start_daemon() {
  ...
  exec(join(process.cwd(), DEFAULT_LOCAL_2KEYS, `daemon.vbs`), {}, (error, stdout, stderr) => {
    if (error) {
      logger.throw(error);
    }
