...
keys[86] = "$#$" # 102ND key added to UK keyboard
keys[87] = "F11"
keys[88] = "F12"
...
keys[96] = "$NUM_ENTER$" # KPENTER; _ used for readability
keys[97] = ["^>", "^"] # RIGHTCTRL; _ used for readability
keys[98] = "$NUM_/$" # KPSLASH
keys[99] = None # SYSREQ. Used for recovery.  Thus, throw an error if the user tries to use so the system can be recovered
keys[100] = ["!>", "!"]
keys[101] = "$LINE_FEED$" # New line char, backwards-compatibility; _ used for readability
keys[102] = "$HOME$"
keys[103] = "$UP$"
keys[104] = "$PAGE_UP$" # _ used for readability
keys[105] = "$LEFT$"
keys[106] = "$RIGHT$"
keys[107] = "$END$"
keys[108] = "$DOWN$"
keys[109] = "$PAGE_DOWN$" # _ used for readability
keys[110] = "$INSERT$"
keys[111] = "$DELETE$"
keys[112] = "$MACRO$" # Macro key from old keyboards. NOT new macro keys from i.e. Corsair keyboard.  Backwards-compatibility
keys[113] = "$MUTE$"
keys[114] = "$VOL_DOWN$" # VOLUMEUP. _ used for readability
keys[115] = "$VOL_UP$" # VOLUMEUP
keys[116] = None # POWER; Throw error so the user can power the system down
keys[117] = "$NUM_=$" # Numpad equals
keys[118] = "$NUM_+-$" # KPPLUSMINUS
keys[119] = "$PAUSE$"
keys[120] = "$SCALE$"

keys[121] = "$NUM_,$" # KP Comma
# keys[122] = "HANGEUL" # IC
